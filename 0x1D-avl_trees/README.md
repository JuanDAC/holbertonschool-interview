...
`typedef struct binary_tree_s avl_t; ` ### Print function
...
### 0. Is AVL
          ...
          Level: -1                    Auto review           Progress vs Score  Task Body Write a function that checks if a binary tree is a valid  [AVL Tree](https://intranet.hbtn.io/rltoken/6g6I1RrURewjvM4xxnDOWQ)
...
- The left and right subtree each must also be a binary search tree
  Note: In order for the main file to compile, you are provided with [this static library](https://s3.amazonaws.com/intranet-projects-files/interviews/484/libavl.a)
