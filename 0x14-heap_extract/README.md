...
By: Alexa Orrico, Software Engineer at Holberton School Weight: 1Ongoing second chance project - startedSep 12, 2022 12:00 AM, must end bySep 19, 2022 12:00 AM An auto review will be launched at the deadline#### In a nutshell…
...
`typedef struct binary_tree_s heap_t; ` ### Print function
...
### 0. Heap - Extract
          ...
          mandatory         Progress vs Score           Score: 0.00% (Checks completed: 0.00%)         Task Body Write a function that extracts the root node of a Max Binary Heap:
